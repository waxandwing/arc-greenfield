...
assert(week.startDate === '2026-08-08', 'Week projection must begin Saturday.')
assert(week.endDate === '2026-08-14', 'Week projection must end Friday.')
assert(week.days.length === 7, 'Week projection must expose seven calendar days.')
assert(week.days[4].kind === 'no-school', 'Week projection must preserve no-school truth.')
assert(week.days[0].isWeekend, 'Week projection must identify Saturday as weekend.')
assert(week.days[1].isWeekend, 'Week projection must identify Sunday as weekend.')
...
assert(month.gridStartDate === '2026-08-01', 'Month projection must begin on the Saturday covering the first of month.')
assert(month.gridEndDate === '2026-09-04', 'Month projection must end on the Friday covering month end.')
assert(month.weeks.length === 5, 'August 2026 requires five Saturday–Friday grid rows.')
