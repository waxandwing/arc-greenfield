...
assert(week.startDate === '2026-08-09', 'Week projection must begin Sunday.')
assert(week.endDate === '2026-08-15', 'Week projection must end Saturday.')
assert(week.days.length === 7, 'Week projection must expose seven calendar days.')
assert(week.days[3].kind === 'no-school', 'Week projection must preserve no-school truth.')
assert(week.days[0].isWeekend, 'Week projection must identify Sunday as weekend.')
assert(week.days[6].isWeekend, 'Week projection must identify Saturday as weekend.')
...
assert(month.gridStartDate === '2026-07-26', 'Month projection must begin on the Sunday covering the first of month.')
assert(month.gridEndDate === '2026-09-05', 'Month projection must end on the Saturday covering month end.')
assert(month.weeks.length === 6, 'August 2026 requires six Sunday–Saturday grid rows.')
