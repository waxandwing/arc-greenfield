...
export function parseOcpsCalendarText(input: OcpsCalendarParseInput): OfficialCalendarStructuredExtraction {
  ...
  pushSingle(rows, text, /Monday\s+January 18\s+Martin Luther King, Jr\. Holiday\s+Schools and District Offices Closed/i, '2027-01-18', 'Martin Luther King, Jr. Holiday; Schools and District Offices Closed')
  pushSingle(rows, text, /Monday\s+February 15\s+Presidents[’'] Day\/Teacher Non-Work Day\s+Schools Closed\/District Offices Open/i, '2027-02-15', 'Presidents’ Day/Teacher Non-Work Day; Schools Closed/District Offices Open')
  ...
  pushRange(rows, text, /Monday-Friday\s+March 15-19\s+Spring Break\s+Schools Closed\/District Offices Open/i, '2027-03-15', '2027-03-19', 'Spring Break; Schools Closed/District Offices Open')
