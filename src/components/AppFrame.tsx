  ...
  return (
    <div className="arc-shell">
      ...
      <header className="arc-header" aria-label="Arc application header">
        <button className="arc-wordmark" type="button" aria-label={onboardingActive ? 'Exit setup to Arc' : 'Return to Teaching Day'} onClick={returnHome}><img src="/assets/arctable/logo-icon-framed-arc-primary-256.png" alt="Arc" /></button>
