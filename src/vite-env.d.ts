...
interface ImportMetaEnv {
  ...
  /** When "true", production desk preview shows build stamp (npm run preview:desk). */
  readonly VITE_ARC_DESK_PREVIEW?: string
  readonly VITE_ARC_BUILD_LABEL?: string
  readonly VITE_ARC_GIT_SHA?: string
}
