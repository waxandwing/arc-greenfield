...
test("Shift preview translates current schedule consequences into canonical impact vocabulary", () => {
  ...
  assert.ok(impact.shifted.some((item) => item.id === "studio-contour" && item.fromDate === "2026-09-14" && item.toDate === "2026-09-15"));
