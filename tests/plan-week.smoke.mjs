...
try {
  ...
  console.log('Arc Plan Week context gate passed: Day/Class/Lesson entry, selected-date return, Workspace overlay, Home, refresh, stale IDs, Section divergence, ArcTable isolation.')
} finally {
  await browser.close()
}
