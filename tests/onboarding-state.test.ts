...
import { onboardingCompletedCount, onboardingReady, onboardingStepComplete } from "../lib/onboarding-state";
...
test("onboarding does not report ready until the required school-year start exists", () => {
  const workspace = emptyWorkspace();
  workspace.teacherName = "Kelly";
  workspace.courses.push({ id: "course-1", name: "AP Art History", periodLabel: "2", color: "#53788A" });
