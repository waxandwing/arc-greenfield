...
const evidenceDir = new URL('../docs/overnight/evidence/stage7-2-2-shell-visibility/', import.meta.url).pathname
...
try {
  ...
  console.log(`Stage 7.2.2 shell visibility evidence captured in ${evidenceDir}`)
} finally {
  await browser.close()
}
