...
**Current app screenshot (not visual target):** Kelly’s desk v3 preview-repair capture documents **today’s broken display** (month view / layout drift). Kept at `docs/overnight/evidence/kelly-current-display-2026-08-03.png` and `uploads/desk-incoming/kelly-desk-v3-preview-repair-2026-08-03.png` for baseline comparison only — see `docs/overnight/KELLY-CURRENT-VS-TARGET.md`.
...
2. Compare against **Kelly Teaching week comp + 37:11052** before and after; capture evidence under `docs/overnight/evidence/`.
